...
int _messageEntityEstimateSize(
  ...
  bytesCount += 3 + object.textVolume.length * 3;
  return bytesCount;
}
...
void _messageEntitySerialize(
  ...
  writer.writeBool(offsets[1], object.isEdited);
  ...
  writer.writeString(offsets[8], object.textVolume);
...
MessageEntity _messageEntityDeserialize(
  ...
  object.id = id;
  object.isEdited = reader.readBool(offsets[1]);
  ...
  object.textVolume = reader.readString(offsets[8]);
...
extension MessageEntityQueryFilter
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterFilterCondition>
      textVolumeContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'textVolume',
        value: value,
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterFilterCondition>
      textVolumeMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'textVolume',
        wildcard: pattern,
...
extension MessageEntityQuerySortBy
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterSortBy> sortByIsEdited() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterSortBy> sortByIsSynced() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterSortBy> sortByMediaType() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterSortBy> sortByTextVolume() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'textVolume', Sort.asc);
    });
  }

  QueryBuilder<MessageEntity, MessageEntity, QAfterSortBy>
      sortByTextVolumeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'textVolume', Sort.desc);
    });
  }
...
extension MessageEntityQuerySortThenBy
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterSortBy> thenByIsEdited() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEdited', Sort.asc);
    });
  }
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterSortBy> thenByIsSynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSynced', Sort.asc);
    });
  }
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterSortBy> thenByMediaType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mediaType', Sort.asc);
    });
  }
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterSortBy> thenByTextVolume() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'textVolume', Sort.asc);
    });
  }
...
extension MessageEntityQueryWhereDistinct
  ...
  QueryBuilder<MessageEntity, MessageEntity, QDistinct> distinctByIsEdited() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageEntity, MessageEntity, QDistinct> distinctByIsSynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isSynced');
    });
  }

  QueryBuilder<MessageEntity, MessageEntity, QDistinct> distinctByMediaType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageEntity, MessageEntity, QDistinct> distinctByTextVolume(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'textVolume', caseSensitive: caseSensitive);
    });
  }
...
extension MessageEntityQueryProperty
  ...
  QueryBuilder<MessageEntity, bool, QQueryOperations> isEditedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageEntity, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isSynced');
    });
  }

  QueryBuilder<MessageEntity, String, QQueryOperations> mediaTypeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageEntity, String, QQueryOperations> textVolumeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'textVolume');
    });
  }
